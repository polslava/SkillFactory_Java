...
//не сдано:
// в тестере не учитываются по высоте (разница с тестом в последнем знаке после запятой)
// и высота вертикального параллелограмма (сторона а увеличена, но в тестере она легла вниз, а в ТЗ - боковая)
