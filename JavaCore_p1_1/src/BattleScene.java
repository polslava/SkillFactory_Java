...
public class BattleScene {
    ...
    public void fight(Entity hero, Entity monster, Main.FightCallback fightCallback) {
    ...
    private Boolean makeHit(Entity defender, Entity attacker, Main.FightCallback fightCallback) {
        //Получаем силу удара
